  ...
  return (
    <SiteFrame>
      <PageLead
        ...
        intro="This page honors the hands behind the work. We group crafts by maker traditions, regions and techniques, not just by product type."
        aside={"Focus on makers\nRegional traditions"}
      />
